...
public class BossAttack extends Sprite {
    ...
    public BossAttack(GameView gameView, Bitmap bmp, Boss boss, int laserStyle) {
        super(gameView, bmp);
        this.speed = 10;
        this.height = bmp.getHeight() / BMP_ROWS;
        this.width = bmp.getWidth() / BMP_COLUMNS;
        this.x = boss.getX() + boss.getWidth() / 2 - width / 2;
        this.y = boss.getY() + boss.getHeight();
